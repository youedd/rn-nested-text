...
const parser = (function () {
  const o = function (k, v, o, l) { for (o = o || {}, l = k.length; l--; o[k[l]] = v);return o }; const $V0 = [2, 3]; const $V1 = [1, 6]; const $V2 = [1, 7]; const $V3 = [5, 10]; const $V4 = [5, 9, 10, 11]
  const parser = {
    ...
    parse: function parse (input) {
      const self = this; let stack = [0]; const tstack = []; let vstack = [null]; let lstack = []; const table = this.table; let yytext = ''; let yylineno = 0; let yyleng = 0; let recovering = 0; const TERROR = 2; const EOF = 1
