...
it('should parse simple text', () => {
	expect(Parser.parse('this is a test !'))
		.toEqual(
			['this is a test !']
		);
});
...
it('should parse styled text', () => {
	expect(Parser.parse('<b>this is a test !</b>'))
		.toEqual(
			[
...
it('should parse mixed text', () => {
	expect(Parser.parse('this is a <b> test !</b>'))
		.toEqual(
			[
				'this is a ',
				{tag: 'b', children: [' test !']}
	...
	expect(Parser.parse('<c>this</c> is a< b   > test </  b  >!'))
		.toEqual(
			[
				{tag: 'c', children: ['this']},
				' is a',
...
it('should parse nested styled text', () => {
	expect(Parser.parse('this is a <b> <c>nested</c> test !</b>'))
		.toEqual(
			[
				'this is a ',
				{
